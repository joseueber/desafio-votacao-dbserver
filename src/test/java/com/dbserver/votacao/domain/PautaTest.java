...
class PautaTest {
    ...
    void deveFalharQuandoTituloNuloOuEmBranco() {
        ...
        final var ex1 =
                assertThrows(IllegalArgumentException.class, () -> new Pauta(UUID.randomUUID(), null, null, agora));
        assertEquals("título não pode ser vazio", ex1.getMessage());

        final var ex2 =
                assertThrows(IllegalArgumentException.class, () -> new Pauta(UUID.randomUUID(), "   ", null, agora));
