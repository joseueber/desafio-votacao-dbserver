...
public final class SessaoVotacao {
  ...
  public static SessaoVotacao abrir(UUID pautaId, Instant agora, Duration duracao) {
    ...
    return new SessaoVotacao(null, pautaId, agora, agora.plus(duracao), SessaoStatus.ABERTA);
  }
